...
import 'package:new_save_money/commons/navigation_bar/navigation_bar.dart';
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final categoryIcon = log.icon; 
                      final color = log.color; 
                      final price = log.price;
                      final day = log.dataTime;
                        ...
                        child: Stack(
                          children: [
                            ListTile(
                              ...
                              subtitle: Text(
                                day.year.toString() + '年' + day.month.toString() + '月' + day.day.toString() + '日', 
                                style: TextStyle(
                                  fontSize: 13,
